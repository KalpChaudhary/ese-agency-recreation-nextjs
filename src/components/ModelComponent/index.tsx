...
import { contentReveal, modelOpacity, modelReveal } from './anime';
...
function ModelComponent({ setIsModelActive, isModelActive }: { setIsModelActive: React.Dispatch<React.SetStateAction<boolean>>, isModelActive: boolean }) {
    return (
        ...
        <>
            ...
            <motion.div variants={modelOpacity(isModelActive)} initial="initial" animate="enter" className={styles.modelOpacityContainer}></motion.div>
        </>
